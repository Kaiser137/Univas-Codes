...
import visao.telas.TelaListaAgendamentosSecretaria;
import visao.telas.TelaSelecionarPacienteParaAtualizarContato;
...
public class MenuSecretaria extends JFrame {
    ...
    public MenuSecretaria(int idSecretaria) {
        ...
        btnAtualizar.addActionListener(e -> {
            dispose();
            new TelaSelecionarPacienteParaAtualizarContato(this.idSecretaria);
        });
        ...
        btnListarAgendamentos.addActionListener(e -> {
            dispose(); // Fecha o menu
            new TelaListaAgendamentosSecretaria(this.idSecretaria);
        });
